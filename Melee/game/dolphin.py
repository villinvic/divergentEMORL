...
from Melee.codes.boot2match import generate_match_code
from Melee.codes import codes
from config.Loader import Default


class DolphinInstance(Default):

    def __init__(self, exe_path , iso_path, test, ID, config_path='Melee/dolphin/User/GameSettings/GALE01.ini'):
